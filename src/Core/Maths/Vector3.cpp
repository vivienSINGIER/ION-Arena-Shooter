...
namespace gce
{
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////
	Vector3i32::Vector3i32(int32 x, int32 y, int32 z)
	{
		Store(_mm_set_ps(0, z, y, x));
	}
	...
	/// @return A Vector3 object initialized with the specified values.
	///////////////////////////////////////////////////////////////////////
	Vector3i32::Vector3i32(int32 values[3])
	{
		memcpy(m_pData, values, 3 * sizeof(int32));
	}
	...
	/// @return A Vector3 object initialized with copied values from other.
	///////////////////////////////////////////////////////////////////////////
	Vector3i32::Vector3i32(Vector3i32 const& other)
	{
		*this = other;
	}
	...
	/// @return A reference to this vector.
	///////////////////////////////////////////////////////////
	Vector3i32& Vector3i32::operator=(Vector3i32 const& other)
	{
		memcpy(m_pData, other.m_pData, 3 * sizeof(int32));
		return *this;
	}
	...
	/// @note This function uses SIMD instructions.
	//////////////////////////////////////////////////////////
	int32 Vector3i32::DotProduct(Vector3i32 const& other) const
	{
		__m128 v1 = Load();
		__m128 v2 = other.Load();
	...
	/// @note This function uses SIMD instructions. Faster than GetNorm().
	//////////////////////////////////////////////////////////////////////////
	int32 Vector3i32::SquareNorm() const
	{
		__m128 v = Load();
		// Perform the dot product on x,y and z
		__m128 vLengthSq = _mm_mul_ps(v, v);
	...
	/// @note This function uses SIMD instructions.
	////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::CrossProduct(Vector3i32 const& other) const
	{
		__m128 v1 = Load();
		__m128 v2 = other.Load();
	...
	/// @note This function uses SIMD instructions.
	////////////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::Normalize() const
	{
		__m128 v = Load();
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////
	Vector3i32& Vector3i32::SelfNormalize()
	{
		__m128 v = Load();
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::operator-(Vector3i32 const& right) const
	{
		__m128 v1 = Load();
		v1.m128_f32[3] = 0;
		__m128 v2 = right.Load();
		...
		return Vector3i32(_mm_sub_ps(v1, v2));
	}
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::operator+(Vector3i32 const& other) const
	{
		__m128 v1 = Load();
		__m128 v2 = other.Load();

		return Vector3i32(_mm_add_ps(v1, v2));
	}
	...
	/// @note This function uses SIMD instructions.
	/////////////////////////////////////////////////////////////////////////////
	Vector3i32 gce::Vector3i32::operator*(Vector3i32 const& other) const
	{
		__m128 v1 = Load();
		__m128 v2 = other.Load();

		return Vector3i32(_mm_mul_ps(v1, v2));
	}
	...
	Vector3i32 Vector3i32::operator/(Vector3i32 const& right) const
	{
		...
		return Vector3i32(_mm_div_ps(v1, v2));
	}
	...
	/// @note This function uses SIMD instructions.
	//////////////////////////////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::operator*(int32 const scalar) const
	{
		__m128 v1 = Load();
		__m128 v2 = _mm_set1_ps(scalar);
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////////
	Vector3i32 Vector3i32::operator-() const
	{
		__m128 v1 = Load();
		__m128 scalarV = _mm_set1_ps(-1);
	...
	/// @return The value at the given index.
	////////////////////////////////////////////////////////
	int32& Vector3i32::operator[](int8 const index)
	{
		return m_pData[index];
	}
	...
	/// @return The value at the given index.
	////////////////////////////////////////////////////////
	int32 const& Vector3i32::operator[](int8 const index) const
	{
		return m_pData[index];
	}
	...
	/// @note This function uses SIMD instructions.
	////////////////////////////////////////////////////////////////////////////////////////////
	Vector3i32& Vector3i32::operator-=(Vector3i32 const& right)
	{
		__m128 v1 = Load();
		__m128 v2 = right.Load();
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	Vector3i32& Vector3i32::operator*=(int32 const scalar)
	{
		__m128 v1 = Load();
		__m128 v2 = _mm_set1_ps(scalar);
	...
	/// @note This function uses SIMD instructions.
	///////////////////////////////////////////////////////////////////////////
	bool Vector3i32::operator==(Vector3i32 const& other) const
	{
		__m128 v1 = Load();
		__m128 v2 = other.Load();
		__m128 res = _mm_cmpeq_ps(v1, v2);
	...
	Vector3i32 Vector3i32::Lerp(Vector3i32 const& a, Vector3i32 const& b, float t)
	{
		__m128 v1 = a.Load();
		__m128 v2 = b.Load();
	...
	Vector3i32 Vector3i32::Lerp(Vector3i32 const& a, Vector3i32 const& b, Vector3i32 const& t)
	{
		__m128 v1 = a.Load();
		__m128 v2 = b.Load();
		__m128 v3 = t.Load();
	...
	Vector3i32::Vector3i32(__m128 v)
	{
		Store(v);
	}
	
	__m128 Vector3i32::Load() const
	{
		// Load 128 bits as int32 (x, y, z, padding)
		__m128i vi = _mm_loadu_si128(reinterpret_cast<const __m128i*>(m_pData));

		// Convert int32 → float
		return _mm_cvtepi32_ps(vi);
	}

	void _vectorcall Vector3i32::Store(__m128 v)
	{
		// Convert float → int32
		__m128i vi = _mm_cvtps_epi32(v);

		// Store first 3 ints
		_mm_storeu_si128(reinterpret_cast<__m128i*>(m_pData), vi);
	}
}